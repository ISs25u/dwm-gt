...
static const char *fonts[]          = {"monospace:size=10:pixelsize=13:antialias=true:autohint=true"};
static char dmenufont[]             = "monospace:size=10:pixelsize=13:antialias=true:autohint=true";
...
const char *spcmd4[] = {"st", "-n", "spmixer", "-g", "120x34", "-e", "pulsemixer", "kill", "-44", "$(pidof dwmblocks)", NULL };
