...
static const char *fonts[]          = {"monospace:size=12:pixelsize=14:antialias=true:autohint=true"};
static char dmenufont[]             = "monospace:size=12:pixelsize=14:antialias=true:autohint=true";
